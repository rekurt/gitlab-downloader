...
describe('printDryRun', () => {
  ...
  test('prints header and project rows', () => {
    ...
    const buildCloneTarget = (project, _cfg) => ({ repoName: project.name, targetPath: `/tmp/repos/${project.group_path}/${project.name}` });
  ...
  test('handles empty project list', () => {
    printDryRun([], {}, () => ({ repoName: '', targetPath: '' }), options);
  ...
  test('truncates long fields', () => {
    ...
    const buildCloneTarget = (project) => ({ repoName: project.name, targetPath: '/tmp/target' });
  ...
  test('handles missing fields gracefully', () => {
    ...
    const buildCloneTarget = () => ({ repoName: 'proj', targetPath: '/tmp/proj' });
  ...
  test('uses console.log by default', () => {
    ...
    printDryRun([], {}, () => ({ repoName: '', targetPath: '' }));
