...
- [x] Проанализировать текущие staged/unstaged изменения
- [x] Создать коммит с осмысленным сообщением для текущих изменений
- [x] Убедиться что рабочая директория чистая
